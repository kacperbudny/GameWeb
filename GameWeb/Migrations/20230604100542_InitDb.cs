    ...
    public partial class InitDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteGame", x => new { x.GameId, x.UserId });
                    table.ForeignKey(
                        name: "FK_FavouriteGame_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimalRequirementsId = table.Column<int>(type: "int", nullable: true),
                    RecommendedRequirementsId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.MinimalRequirementsId,
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FavouriteGame_Game_GameId",
                table: "FavouriteGame",
                column: "GameId",
                principalTable: "Game",
                principalColumn: "Id",
